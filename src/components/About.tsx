...
//             I’m passionate and motivated Full Stack Developer with a strong foundation frontend and backend technologies. Skilled in JavaScript, React, Node.js, Express, MongoDB, and MySQL, with hands-on experience building responsive web applications. Eager to apply my knowledge in a professional environment, contribute to innovative projects, and grow as a developer. A quick learner with a problem-solving mindset and a dedication to writing clean,  
//             </p>
//             <p className="text-gray-300 mb-8 leading-relaxed">
//               I'm passionate about clean code, user experience, and staying up-to-date with 
//               the latest technologies. 
//             </p>
//             <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-shadow duration-200">
...
const About = () => {
  ...
  const handleDownloadResume = () => {
    ...
    link.href = '../../public/Abdisa Awel resume.pdf'; // Path to your resume in public folder
